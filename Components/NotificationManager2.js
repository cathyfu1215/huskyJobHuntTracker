/**
 * This notification manager is used to set a notification for a todo 24h later.
 */
import React from 'react'
import { View, Text, Pressable } from 'react-native'
import * as Notifications from "expo-notifications";

function NotificationManager2(props) {
      ...
      return (
        <View>
            <Pressable style={{backgroundColor:'lightblue',padding:10,margin:10}} onPress={scheduleNotificationHandler}>
                <Text style={{color:'black',alignSelf:'center'}}>24h Reminder</Text>
            </Pressable>
        </View>
      )
...
export default NotificationManager2;